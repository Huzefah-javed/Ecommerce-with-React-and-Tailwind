...
export const HeaderMenubarDetail=()=> {
    return <div className="fixed -top-0 h-dvh w-dvw bg-white p-8 z-[99]">
        ...
        <button className=" h-fit w-fit text-[1.4rem] box-shadow p-2 cursor-pointer"><GrClose /></button>
        </header>
        <div className="main-container flex justify-start overflow-y-scroll">
            <div className="login-detail flex flex-col m-8 w-[24rem]">
                ...
                <div className="password mb-8 flex flex-col">
                    ...
                    <input className=" border-[0.5px] border-black border-solid p-3" type="password" name="password" id="email" />
                </div>
