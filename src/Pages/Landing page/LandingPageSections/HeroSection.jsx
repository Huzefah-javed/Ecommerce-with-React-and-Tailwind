...
export const HeroSection =({bg_link, heading, para, button_text,})=> {
    return <>
       <div style={{ backgroundImage: `url(${bg_link})` }} className={`h-screen w-full mb-16 relative z-10 flex justify-center flex-col bg-cover bg-center before:absolute before:z-20 before:h-full before:w-full before:bg-black before:opacity-50`}>
