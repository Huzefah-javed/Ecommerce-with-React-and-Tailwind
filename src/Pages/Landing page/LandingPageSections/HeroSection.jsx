...
export const HeroSection =({bg_link, heading, para, button_text,})=> {
    return <>
       <div className={`h-screen w-full relative flex justify-center flex-col bg-[url(${bg_link})] bg-cover bg-top before:absolute before:z-10 before:h-full before:w-full before:bg-black before:opacity-40`}>
