    ...
    return (
        ...
        >
            <div className="flex flex-col mt-10 ml-10 max-w-2xl">
                <h1 className="text-6xl font-extrabold font-sans text-white relative z-20">
                    {heading}
                </h1>
                <p className="text-2xl font-medium font-sans pt-10 pb-10 text-white relative z-20">
                    {para}
                </p>
                {!buttonNone && (
                    <NavLink to="/products">
