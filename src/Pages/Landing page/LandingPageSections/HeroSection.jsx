...
export const HeroSection =({bg_link, heading, para, button_text,  buttonNone, height})=> {
    return <>
       <div style={{ backgroundImage: `url(${bg_link})`, height:`${height? `${height}`: "100vh"}` }} className={`w-full mb-16 relative z-10 flex justify-center flex-col bg-cover bg-center before:absolute before:z-20 before:h-full before:w-full before:bg-black before:opacity-50`}>
        <div className="flex flex-col mt-10 ml-10 max-w-2xl">
            ...
            {buttonNone? "": <NavLink to="/products"><MainButton text={button_text}/></NavLink>}
        </div>
