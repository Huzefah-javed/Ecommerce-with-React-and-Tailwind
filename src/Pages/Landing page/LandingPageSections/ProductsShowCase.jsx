...
export const ProductsShowCase = ({searchedItem, title, titleCategory})=>{
    ...
    return <div className="w-full px-4">
        <header className="flex justify-between">
            <h1 className="text-6xl font-extrabold font-sans uppercase">{title}</h1>
            <h2 className="group flex gap-2 items-center text-[1.1rem] font-extrabold font-sans cursor-pointer">{titleCategory} <img className="w-[1rem] transition-all duration-500 ease-in-out group-hover:translate-x-2" src="arrow image.png" alt="arrow image"/></h2>
        </header>
